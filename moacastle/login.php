...
<body style="font-family: 'Poppins', sans-serif;background: #B7C4CF;">
    ...
    <br><br>
        ...
        <div class="row" >
        <div class="col-md-6 ">
        <div class="card my-6 shadow-lg" style="background: #6780a1;">
            <form class="card-body cardbody-color p-lg-4 text-white ">
            <h2 class="mb-3 mt-4 text-center text-white">L O G I N</h2>
      ...
      <div class="col-md-6 mt-5">
        <img src="moa.png" class="img-fluid rounded mx-auto d-block" width="500px" alt="">
    </div>
</body>
</html>